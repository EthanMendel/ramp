...
//initialize points and call overloaded method
void BezierCurve::initControlPoints() {
  ...
  // if 1st segment is smaller than 2nd
  // get first point and call overloaded method
  if(l_s1 < l_s2) {
...
/** initalize control points of the Bezier curve **/
