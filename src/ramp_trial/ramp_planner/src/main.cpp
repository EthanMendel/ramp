...
// initialize global start and goal
...
void loadParameters(const ros::NodeHandle handle){
    ...
    // dofs
    if (handle.hasParam("robot_info/DOF_min") && handle.hasParam("robot_info/DOF_max")){
    ...
    if (handle.hasParam("robot_info/start") && handle.hasParam("robot_info/goal")){
