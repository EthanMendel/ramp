...
echo_and_run cd "/home/emendel/Documents/IndepententStudy/ramp/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/home/emendel/Documents/IndepententStudy/ramp/src/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/emendel/Documents/IndepententStudy/ramp/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
