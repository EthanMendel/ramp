...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectorySrv-request>)))
  ...
  "74cb2a92026a7e1f5cd832b3efb48cb0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectorySrv-request)))
  "Returns md5sum for a message object of type 'TrajectorySrv-request"
  "74cb2a92026a7e1f5cd832b3efb48cb0")
...
(cl:defmethod trajectory-val ((m <TrajectorySrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ramp_msgs-srv:trajectory-val is deprecated.  Use ramp_msgs-srv:trajectory instead.")
  (trajectory m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <TrajectorySrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ramp_msgs-srv:error-val is deprecated.  Use ramp_msgs-srv:error instead.")
  (error m))
