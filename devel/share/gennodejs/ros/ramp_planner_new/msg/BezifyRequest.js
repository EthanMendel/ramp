...
class BezifyRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('pathPoints')) {
        this.pathPoints = initObj.pathPoints
      }
      else {
        this.pathPoints = new PathPoints();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [pathPoints]
    bufferOffset = PathPoints.serialize(obj.pathPoints, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BezifyRequest(null);
    // Deserialize message field [pathPoints]
    data.pathPoints = PathPoints.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += PathPoints.getMessageSize(object.pathPoints);
  ...
  static datatype() {
    ...
    return 'ramp_planner_new/BezifyRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BezifyRequest(null);
    if (msg.pathPoints !== undefined) {
      resolved.pathPoints = PathPoints.Resolve(msg.pathPoints)
    }
    else {
      resolved.pathPoints = new PathPoints()
    }
