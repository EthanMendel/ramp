...
class TrajectorySwap {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectorySwap(null);
  ...
  static datatype() {
    ...
    return 'ramp_planner_new/TrajectorySwap';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectorySwap(null);
