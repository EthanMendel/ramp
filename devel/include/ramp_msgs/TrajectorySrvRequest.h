...
bool operator==(const ::ramp_msgs::TrajectorySrvRequest_<ContainerAllocator1> & lhs, const ::ramp_msgs::TrajectorySrvRequest_<ContainerAllocator2> & rhs)
{
  return lhs.reqs == rhs.reqs;
}
