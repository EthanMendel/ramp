...
"""autogenerated by genpy from ramp_msgs/HilbertMap.msg. Do not edit."""
import codecs
import sys
...
class HilbertMap(genpy.Message):
  _md5sum = "b6a8a2af53f4c3c36388c3b8ae08732f"
  _type = "ramp_msgs/HilbertMap"
...
"""
  __slots__ = ['map','gamma']
  _slot_types = ['nav_msgs/OccupancyGrid','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HilbertMap, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.gamma,) = _get_struct_d().unpack(str[start:end])
      return self
