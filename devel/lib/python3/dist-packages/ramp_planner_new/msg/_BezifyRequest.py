...
"""autogenerated by genpy from ramp_planner_new/BezifyRequest.msg. Do not edit."""
import codecs
import sys
...
class BezifyRequest(genpy.Message):
  _md5sum = "e4f2e0353c794b8d0956ee4b179622e2"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BezifyRequest, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.pathPoints is None:
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.pathPoints.markers)
      buff.write(_struct_I.pack(length))
      for val1 in self.pathPoints.markers:
        _v1 = val1.header
        _x = _v1.seq
        ...
        buff.write(_get_struct_B().pack(_x))
      length = len(self.pathPoints.types)
      buff.write(_struct_I.pack(length))
      for val1 in self.pathPoints.types:
        length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.pathPoints.markers.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pathPoints.types = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.pathPoints.types.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.markers = []
